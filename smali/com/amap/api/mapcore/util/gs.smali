...
.method static a()Ljava/security/PublicKey;
    ...
    invoke-static {v2}, Lcom/amap/api/mapcore/util/fd;->b(Ljava/lang/String;)[B
    ...
    :try_start_2
    invoke-static {v2}, Lcom/amap/api/mapcore/util/gs;->a(Ljava/io/Closeable;)V
    :try_end_2
    ...
    invoke-static {v0, v3, v4}, Lcom/amap/api/mapcore/util/gs;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3
...
.method static a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, p2}, Lcom/amap/api/mapcore/util/fl;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
...
.method static a(Ljava/util/List;)V
    ...
    check-cast v1, Lcom/amap/api/mapcore/util/gr;

    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/gr;->e()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v1}, Lcom/amap/api/mapcore/util/gr;->e()Ljava/lang/String;

    move-result-object v5

    invoke-static {v5, v4}, Lcom/amap/api/mapcore/util/gs;->a(Ljava/lang/String;Ljava/lang/String;)I
...
.method static a(Landroid/content/Context;Lcom/amap/api/mapcore/util/fu;Ljava/lang/String;Lcom/amap/api/mapcore/util/fh;)Z
    .locals 1
    ...
    invoke-static {p1, p2, v0, p3}, Lcom/amap/api/mapcore/util/gs;->a(Lcom/amap/api/mapcore/util/fu;Ljava/lang/String;Ljava/lang/String;Lcom/amap/api/mapcore/util/fh;)Z
...
.method static a(Lcom/amap/api/mapcore/util/fu;Ljava/lang/String;Ljava/lang/String;Lcom/amap/api/mapcore/util/fh;)Z
    .locals 4

    const/4 v0, 0x0

    invoke-static {p0, p1}, Lcom/amap/api/mapcore/util/gn$a;->a(Lcom/amap/api/mapcore/util/fu;Ljava/lang/String;)Lcom/amap/api/mapcore/util/gr;
    ...
    invoke-virtual {v1}, Lcom/amap/api/mapcore/util/gr;->d()Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v1}, Lcom/amap/api/mapcore/util/gr;->b()Ljava/lang/String;

    move-result-object v1

    invoke-static {p2, v1}, Lcom/amap/api/mapcore/util/gs;->b(Ljava/lang/String;Ljava/lang/String;)Z
...
.method static b(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lcom/amap/api/mapcore/util/fe;->a(Ljava/lang/String;)Ljava/lang/String;
