...
.method public constructor <init>(Landroid/content/Context;Lcom/amap/api/mapcore/util/l;)V
    ...
    iput-object p2, p0, Lcom/amap/api/mapcore/util/ej;->e:Lcom/amap/api/mapcore/util/l;
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/util/ej;->c:Landroid/graphics/Bitmap;
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/util/ej;->b:Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/util/ej;->b:Landroid/graphics/Bitmap;
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/util/ej;->a:Landroid/graphics/Bitmap;

    new-instance v0, Landroid/graphics/Canvas;

    iget-object v1, p0, Lcom/amap/api/mapcore/util/ej;->a:Landroid/graphics/Bitmap;
    ...
    iget-object v4, p0, Lcom/amap/api/mapcore/util/ej;->b:Landroid/graphics/Bitmap;

    invoke-virtual {v4}, Landroid/graphics/Bitmap;->getHeight()I

    move-result v4

    iget-object v5, p0, Lcom/amap/api/mapcore/util/ej;->c:Landroid/graphics/Bitmap;
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/util/ej;->d:Landroid/widget/ImageView;
    ...
    invoke-virtual {p0}, Lcom/amap/api/mapcore/util/ej;->a()V

    iget-object v0, p0, Lcom/amap/api/mapcore/util/ej;->d:Landroid/widget/ImageView;

    new-instance v1, Lcom/amap/api/mapcore/util/ej$1;

    invoke-direct {v1, p0}, Lcom/amap/api/mapcore/util/ej$1;-><init>(Lcom/amap/api/mapcore/util/ej;)V

    invoke-virtual {v0, v1}, Landroid/widget/ImageView;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V

    iget-object v0, p0, Lcom/amap/api/mapcore/util/ej;->d:Landroid/widget/ImageView;

    invoke-virtual {p0, v0}, Lcom/amap/api/mapcore/util/ej;->addView(Landroid/view/View;)V
    :try_end_0
...
.method public a()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/mapcore/util/ej;->e:Lcom/amap/api/mapcore/util/l;
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/util/ej;->d:Landroid/widget/ImageView;
    ...
    iget-object v4, p0, Lcom/amap/api/mapcore/util/ej;->d:Landroid/widget/ImageView;
...
.method public a(Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/amap/api/mapcore/util/ej;->setVisibility(I)V
