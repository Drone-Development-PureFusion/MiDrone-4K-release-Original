...
.method private a(Ljava/net/URL;Lcom/android/volley/n;)Ljava/net/HttpURLConnection;
    .locals 3
    ...
    invoke-virtual {p2}, Lcom/android/volley/n;->y()I
...
.method static a(Ljava/net/HttpURLConnection;Lcom/android/volley/n;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :pswitch_0
    invoke-virtual {p1}, Lcom/android/volley/n;->r()[B
    ...
    invoke-virtual {p1}, Lcom/android/volley/n;->q()Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lcom/android/volley/toolbox/j;->b(Ljava/net/HttpURLConnection;Lcom/android/volley/n;)V
...
.method private static b(Ljava/net/HttpURLConnection;Lcom/android/volley/n;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lcom/android/volley/n;->v()[B
    ...
    invoke-virtual {p1}, Lcom/android/volley/n;->u()Ljava/lang/String;
...
.method public a(Lcom/android/volley/n;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lcom/android/volley/n;->g()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/android/volley/n;->n()Ljava/util/Map;
    ...
    invoke-direct {p0, v1, p1}, Lcom/android/volley/toolbox/j;->a(Ljava/net/URL;Lcom/android/volley/n;)Ljava/net/HttpURLConnection;
    ...
    :cond_2
    invoke-static {v3, p1}, Lcom/android/volley/toolbox/j;->a(Ljava/net/HttpURLConnection;Lcom/android/volley/n;)V
    ...
    invoke-static {v0, v1}, Lcom/android/volley/toolbox/j;->a(II)Z
