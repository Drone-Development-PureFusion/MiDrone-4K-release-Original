.class public Lcom/fimi/soul/utils/h;
.super Landroid/database/sqlite/SQLiteOpenHelper;


# static fields
.field public static a:Lcom/fimi/soul/utils/h; = null

.field private static final b:Ljava/lang/String; = "miplaner"
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;I)V
    ...
    iput-object p1, p0, Lcom/fimi/soul/utils/h;->d:Landroid/content/Context;

    return-void
.end method

.method public static a(Landroid/content/Context;)Lcom/fimi/soul/utils/h;
    .locals 3

    const/4 v2, 0x0

    sget-object v0, Lcom/fimi/soul/utils/h;->a:Lcom/fimi/soul/utils/h;

    if-nez v0, :cond_0

    new-instance v0, Lcom/fimi/soul/utils/h;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v2, v2, v1}, Lcom/fimi/soul/utils/h;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;I)V

    sput-object v0, Lcom/fimi/soul/utils/h;->a:Lcom/fimi/soul/utils/h;
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {p1}, Lcom/fimi/soul/utils/av;->a(Landroid/database/sqlite/SQLiteDatabase;)V

    sget-object v0, Lcom/fimi/soul/utils/w;->b:Ljava/lang/String;

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    sget-object v0, Lcom/fimi/soul/utils/d;->b:Ljava/lang/String;

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string v0, "create table  if not exists history_push_message(orderId int auto_increment primary key ,url varchar(600) ,title varchar(20) ,payload varchar(20) ,id varchar(20) ,msgType varchar(20) ,passThrough varchar(20) ,statue varchar(20) ,time varchar(20))"

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    sget-object v0, Lcom/fimi/soul/utils/a/a;->a:Ljava/lang/String;

    invoke-virtual {p1, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    sget-object v0, Lcom/fimi/soul/utils/m;->b:Ljava/lang/String;
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    :pswitch_0
    const-string v0, "drop table if exists flyRecord_tb"
    ...
    :pswitch_1
    const-string v0, "drop table if exists battery_over_dischange_tb"
    ...
    :pswitch_3
    const-string v0, "drop table if exists history_push_message"
