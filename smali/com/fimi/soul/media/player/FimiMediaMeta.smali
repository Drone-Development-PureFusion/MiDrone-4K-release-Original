.class public Lcom/fimi/soul/media/player/FimiMediaMeta;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;
    }
.end annotation
...
# instance fields
.field public mAudioStream:Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;
...
.field public mVideoStream:Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;
...
.method public static parse(Landroid/os/Bundle;)Lcom/fimi/soul/media/player/FimiMediaMeta;
    .locals 10
    ...
    :cond_0
    new-instance v2, Lcom/fimi/soul/media/player/FimiMediaMeta;

    invoke-direct {v2}, Lcom/fimi/soul/media/player/FimiMediaMeta;-><init>()V

    iput-object p0, v2, Lcom/fimi/soul/media/player/FimiMediaMeta;->mMediaMeta:Landroid/os/Bundle;

    const-string v1, "format"

    invoke-virtual {v2, v1}, Lcom/fimi/soul/media/player/FimiMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v2, Lcom/fimi/soul/media/player/FimiMediaMeta;->mFormat:Ljava/lang/String;

    const-string v1, "duration_us"

    invoke-virtual {v2, v1}, Lcom/fimi/soul/media/player/FimiMediaMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v4

    iput-wide v4, v2, Lcom/fimi/soul/media/player/FimiMediaMeta;->mDurationUS:J
    ...
    iput-wide v4, v2, Lcom/fimi/soul/media/player/FimiMediaMeta;->mStartUS:J
    ...
    iput-wide v4, v2, Lcom/fimi/soul/media/player/FimiMediaMeta;->mBitrate:J

    const-string v1, "video"

    invoke-virtual {v2, v1, v0}, Lcom/fimi/soul/media/player/FimiMediaMeta;->getInt(Ljava/lang/String;I)I
    ...
    invoke-virtual {v2, v1}, Lcom/fimi/soul/media/player/FimiMediaMeta;->getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    new-instance v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;

    invoke-direct {v6, v1}, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;-><init>(I)V

    iput-object v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mMeta:Landroid/os/Bundle;

    const-string v0, "type"

    invoke-virtual {v6, v0}, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;

    iget-object v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mCodecName:Ljava/lang/String;
    ...
    iput-object v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mCodecProfile:Ljava/lang/String;
    ...
    iput-object v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mCodecLongName:Ljava/lang/String;

    const-string v0, "bitrate"

    invoke-virtual {v6, v0}, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v0

    int-to-long v8, v0

    iput-wide v8, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mBitrate:J
    ...
    iput v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mWidth:I
    ...
    iput v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mHeight:I
    ...
    iput v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mFpsNum:I
    ...
    iput v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mFpsDen:I
    ...
    iput v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mTbrNum:I
    ...
    iput v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mTbrDen:I
    ...
    iput v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mSarNum:I
    ...
    iput v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mSarDen:I

    if-ne v3, v1, :cond_2

    iput-object v6, v2, Lcom/fimi/soul/media/player/FimiMediaMeta;->mVideoStream:Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;
    ...
    iput v0, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mSampleRate:I

    const-string v0, "channel_layout"

    invoke-virtual {v6, v0}, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v8

    iput-wide v8, v6, Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;->mChannelLayout:J

    if-ne v4, v1, :cond_2

    iput-object v6, v2, Lcom/fimi/soul/media/player/FimiMediaMeta;->mAudioStream:Lcom/fimi/soul/media/player/FimiMediaMeta$IjkStreamMeta;
...
.method public getDurationInline()Ljava/lang/String;
    ...
    iget-wide v0, p0, Lcom/fimi/soul/media/player/FimiMediaMeta;->mDurationUS:J
...
.method public getInt(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, p1, v0}, Lcom/fimi/soul/media/player/FimiMediaMeta;->getInt(Ljava/lang/String;I)I
...
.method public getInt(Ljava/lang/String;I)I
    ...
    invoke-virtual {p0, p1}, Lcom/fimi/soul/media/player/FimiMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public getLong(Ljava/lang/String;)J
    ...
    invoke-virtual {p0, p1, v0, v1}, Lcom/fimi/soul/media/player/FimiMediaMeta;->getLong(Ljava/lang/String;J)J
...
.method public getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lcom/fimi/soul/media/player/FimiMediaMeta;->mMediaMeta:Landroid/os/Bundle;
