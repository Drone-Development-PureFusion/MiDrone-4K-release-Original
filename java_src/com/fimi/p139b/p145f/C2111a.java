...
/* renamed from: com.fimi.b.f.a */
/* loaded from: classes.dex */
public class C2111a {
    /* renamed from: a */
    public static int[] m13667a(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length; i += 4) {
            ...
            arrayList.add(m13666b(bArr2));
            bArr2 = new byte[4];
        }
        int[] iArr = new int[arrayList.size()];
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            iArr[i2] = m13665c((byte[]) arrayList.get(i2));
        }
        return iArr;
    }

    /* renamed from: b */
    public static byte[] m13666b(byte[] bArr) {
        byte[] bArr2 = new byte[4];
    ...
    /* renamed from: c */
    public static int m13665c(byte[] bArr) {
