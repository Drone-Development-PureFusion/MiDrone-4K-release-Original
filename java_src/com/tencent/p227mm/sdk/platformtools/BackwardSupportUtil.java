...
public class BackwardSupportUtil {
    ...
    public static class BitmapFactory {
        ...
        public static Bitmap getBitmapFromURL(String str) {
            try {
                Log.m5649d("MicroMsg.SDK.BackwardSupportUtil", "get bitmap from url:" + str);
                ...
                Log.m5647e("MicroMsg.SDK.BackwardSupportUtil", "get bitmap from url failed");
                e.printStackTrace();
                return null;
            }
        }
    ...
    public static class ExifHelper {
        public static int getExifOrientation(String str) {
            ...
            try {
                ...
                Log.m5647e("MicroMsg.SDK.BackwardSupportUtil", "cannot read exif" + e);
                exifInterface = null;
            }
