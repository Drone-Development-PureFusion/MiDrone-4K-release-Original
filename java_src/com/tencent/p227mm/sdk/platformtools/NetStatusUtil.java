...
public class NetStatusUtil {
    ...
    /* renamed from: a */
    private static Intent m5636a(Context context, String str) {
        try {
            PackageManager packageManager = context.getPackageManager();
            List<PackageInfo> installedPackages = packageManager.getInstalledPackages(0);
            if (installedPackages != null && installedPackages.size() > 0) {
                Log.m5647e("MicroMsg.NetStatusUtil", "package  size" + installedPackages.size());
                for (int i = 0; i < installedPackages.size(); i++) {
                    try {
                        Log.m5647e("MicroMsg.NetStatusUtil", "package " + installedPackages.get(i).packageName);
                        ...
                        if (size > 0) {
                            try {
                                Log.m5647e("MicroMsg.NetStatusUtil", "activityName count " + size);
    ...
    public static boolean checkFromXml(int i) {
        try {
            ...
            for (int i2 = 0; i2 < elementsByTagName.getLength(); i2++) {
                ...
                String attribute = element.getAttribute(C3947a.f16896g);
                String attribute2 = element.getAttribute("policy");
                Log.m5647e("MicroMsg.NetStatusUtil", "uid is " + attribute + "  policy is " + attribute2);
    ...
    public static void dumpNetStatus(Context context) {
        try {
            ...
            Log.m5647e("MicroMsg.NetStatusUtil", "isAvailable " + activeNetworkInfo.isAvailable());
            Log.m5647e("MicroMsg.NetStatusUtil", "isConnected " + activeNetworkInfo.isConnected());
            Log.m5647e("MicroMsg.NetStatusUtil", "isRoaming " + activeNetworkInfo.isRoaming());
            Log.m5647e("MicroMsg.NetStatusUtil", "isFailover " + activeNetworkInfo.isFailover());
            Log.m5647e("MicroMsg.NetStatusUtil", "getSubtypeName " + activeNetworkInfo.getSubtypeName());
            Log.m5647e("MicroMsg.NetStatusUtil", "getExtraInfo " + activeNetworkInfo.getExtraInfo());
            Log.m5647e("MicroMsg.NetStatusUtil", "activeNetInfo " + activeNetworkInfo.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static int getNetType(Context context) {
        ...
        if (connectivityManager != null && (activeNetworkInfo = connectivityManager.getActiveNetworkInfo()) != null) {
            ...
            Log.m5649d("MicroMsg.NetStatusUtil", "activeNetInfo.getExtraInfo()  " + activeNetworkInfo.getExtraInfo());
            Log.m5649d("MicroMsg.NetStatusUtil", "activeNetInfo.getType()  " + activeNetworkInfo.getType());
    ...
    */
    ...
    public static boolean isRestrictBacground(Context context) {
        ...
        try {
            ...
            Log.m5647e("MicroMsg.NetStatusUtil", "policy is " + intValue);
        } catch (Exception e) {
            e.printStackTrace();
        }
        if (intValue == 1) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:36:0x0062 A[Catch: Exception -> 0x0066, TRY_LEAVE, TryCatch #5 {Exception -> 0x0066, blocks: (B:42:0x005d, B:36:0x0062), top: B:41:0x005d }] */
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    process = exec;
                    try {
                        Log.m5649d("MicroMsg.NetStatusUtil", "the device is not rooted， error message： " + e.getMessage());
        ...
        switch (i) {
            ...
            case 1:
                try {
                    ...
                    m5636a(context, "DevelopmentSettings");
                    return;
                }
            case 2:
                try {
                    ...
                    try {
                        ...
                        m5636a(context, "ManageAccountsSettings");
                        return;
                    }
                }
            case 3:
                try {
                    ...
                    m5636a(context, "AdvancedSettings");
                    return;
                }
        }
    }
