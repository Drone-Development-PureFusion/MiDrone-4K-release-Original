...
public final class LocaleUtil {
    ...
    public static boolean isLanguageSupported(String str) {
        ...
        return str.equalsIgnoreCase("zh_TW") || str.equalsIgnoreCase("zh_HK") || str.equalsIgnoreCase("zh_CN") || str.equalsIgnoreCase("en") || str.equalsIgnoreCase(THAI) || str.equals("id") || str.equals(VIETNAMESE) || str.equalsIgnoreCase(PORTUGUESE) || str.equalsIgnoreCase(SPANISH) || str.equalsIgnoreCase(RUSSIAN) || str.equalsIgnoreCase(ARABIC) || str.equalsIgnoreCase(HEBREW) || str.equalsIgnoreCase(POLISH) || str.equalsIgnoreCase(HINDI) || str.equalsIgnoreCase(JAPANESE) || str.equalsIgnoreCase(ITALIAN) || str.equalsIgnoreCase(KOREAN) || str.equalsIgnoreCase(MALAY) || str.equalsIgnoreCase(TURKEY);
    }
    ...
    public static String loadApplicationLanguage(SharedPreferences sharedPreferences, Context context) {
        ...
        String m5650b = m5650b("en");
        SystemProperty.setProperty(LANGUAGE_KEY, m5650b);
        return m5650b;
    }
    ...
    public static void saveApplicationLanguage(SharedPreferences sharedPreferences, Context context, String str) {
        if (!sharedPreferences.edit().putString(LANGUAGE_KEY, str).commit()) {
            Log.m5647e("MicroMsg.LocaleUtil", "saving application lang failed");
            return;
        }
        SystemProperty.setProperty(LANGUAGE_KEY, str);
        Log.m5639w("MicroMsg.LocaleUtil", "save application lang as:" + str);
    }
    ...
    public static Locale transLanguageToLocale(String str) {
        ...
        if (!str.equalsIgnoreCase(THAI) && !str.equalsIgnoreCase("id") && !str.equalsIgnoreCase(VIETNAMESE) && !str.equalsIgnoreCase(PORTUGUESE) && !str.equalsIgnoreCase(SPANISH) && !str.equalsIgnoreCase(RUSSIAN) && !str.equalsIgnoreCase(ARABIC) && !str.equalsIgnoreCase(HEBREW) && !str.equalsIgnoreCase(POLISH) && !str.equalsIgnoreCase(HINDI) && !str.equalsIgnoreCase(JAPANESE) && !str.equalsIgnoreCase(ITALIAN) && !str.equalsIgnoreCase(KOREAN) && !str.equalsIgnoreCase(MALAY) && !str.equalsIgnoreCase(TURKEY)) {
            Log.m5647e("MicroMsg.LocaleUtil", "transLanguageToLocale country = " + str);
            return Locale.ENGLISH;
        }
