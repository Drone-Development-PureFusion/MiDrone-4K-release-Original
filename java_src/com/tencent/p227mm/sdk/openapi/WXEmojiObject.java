...
import java.io.File;
/* renamed from: com.tencent.mm.sdk.openapi.WXEmojiObject */
...
public class WXEmojiObject implements WXMediaMessage.IMediaObject {
    ...
    public boolean checkArgs() {
        ...
        if ((this.emojiData == null || this.emojiData.length == 0) && (this.emojiPath == null || this.emojiPath.length() == 0)) {
            Log.m5647e("MicroMsg.SDK.WXEmojiObject", "checkArgs fail, both arguments is null");
            return false;
        } else if (this.emojiData != null && this.emojiData.length > 10485760) {
            Log.m5647e("MicroMsg.SDK.WXEmojiObject", "checkArgs fail, emojiData is too large");
            return false;
        } else {
            if (this.emojiPath != null) {
                ...
                if (i > 10485760) {
                    Log.m5647e("MicroMsg.SDK.WXEmojiObject", "checkArgs fail, emojiSize is too large");
                    return false;
                }
            }
            return true;
