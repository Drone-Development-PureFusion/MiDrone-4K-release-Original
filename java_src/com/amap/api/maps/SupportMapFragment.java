...
public class SupportMapFragment extends Fragment {
    ...
    /* renamed from: b */
    private IMapFragmentDelegate f3602b;
    ...
    protected IMapFragmentDelegate getMapFragmentDelegate() {
        if (this.f3602b == null) {
            try {
                this.f3602b = (IMapFragmentDelegate) C1032gj.m17904a(getActivity(), C0945eh.m18310e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", C1119p.class, new Class[]{Integer.TYPE}, new Object[]{0});
            } catch (Throwable th) {
            }
            if (this.f3602b == null) {
                this.f3602b = new C1119p(0);
                this.f3602b.setContext(getActivity());
            }
        }
        return this.f3602b;
    }
