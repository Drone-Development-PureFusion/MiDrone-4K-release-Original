...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        public Map<K, V> mo21849read(JsonReader jsonReader) {
            ...
            if (peek != JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    K mo21849read = this.keyTypeAdapter.mo21849read(jsonReader);
                    if (construct.put(mo21849read, this.valueTypeAdapter.mo21849read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + mo21849read);
                    }
                }
            ...
            while (jsonReader.hasNext()) {
                jsonReader.beginArray();
                K mo21849read2 = this.keyTypeAdapter.mo21849read(jsonReader);
                if (construct.put(mo21849read2, this.valueTypeAdapter.mo21849read(jsonReader)) != null) {
                    throw new JsonSyntaxException("duplicate key: " + mo21849read2);
                }
                jsonReader.endArray();
            }
            jsonReader.endArray();
