    ...
    public byte[] readCodewords() {
        ...
        while (true) {
            if (i8 == height && i7 == 0 && !z4) {
                bArr[i9] = (byte) readCorner1(height, height);
                int i10 = i7 + 2;
                i3 = i9 + 1;
                i5 = i8 - 2;
                i6 = i10;
                z4 = true;
            } else if (i8 == height - 2 && i7 == 0 && (height & 3) != 0 && !z3) {
                bArr[i9] = (byte) readCorner2(height, height);
                int i11 = i7 + 2;
                i3 = i9 + 1;
                i5 = i8 - 2;
                i6 = i11;
                z3 = true;
            } else if (i8 == height + 4 && i7 == 2 && (height & 7) == 0 && !z2) {
                bArr[i9] = (byte) readCorner3(height, height);
                int i12 = i7 + 2;
                i3 = i9 + 1;
                i5 = i8 - 2;
                i6 = i12;
                z2 = true;
            } else if (i8 == height - 2 && i7 == 0 && (height & 7) == 4 && !z) {
                bArr[i9] = (byte) readCorner4(height, height);
                int i13 = i7 + 2;
                i3 = i9 + 1;
                i5 = i8 - 2;
                i6 = i13;
                ...
                while (true) {
                    if (i17 >= height || i14 < 0 || this.readMappingMatrix.get(i14, i17)) {
                        ...
                        i = i16 + 1;
                        bArr[i16] = (byte) readUtah(i17, i14, height, height);
                    }
                    i17 -= 2;
                    i2 = i14 + 2;
                    if (i17 < 0 || i2 >= height) {
                ...
                int i20 = i;
                while (true) {
                    if (i18 < 0 || i19 >= height || this.readMappingMatrix.get(i19, i18)) {
                        i3 = i20;
                    } else {
                        i3 = i20 + 1;
                        bArr[i20] = (byte) readUtah(i18, i19, height, height);
                    }
                    i18 += 2;
                    i4 = i19 - 2;
                    if (i18 >= height || i4 < 0) {
