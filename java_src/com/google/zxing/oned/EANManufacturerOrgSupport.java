...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{AbstractC4863e.f20805n, 459}, "JP");
            ...
            add(new int[]{IMediaPlayer.MEDIA_INFO_VIDEO_TRACK_LAGGING, 709}, "NO");
            add(new int[]{729}, "IL");
            ...
            add(new int[]{759}, "VE");
            add(new int[]{760, C2427e.f8183M}, "CH");
            add(new int[]{C2427e.f8184N}, "CO");
            add(new int[]{773}, "UY");
            add(new int[]{775}, "PE");
            add(new int[]{777}, "BO");
            add(new int[]{779}, "AR");
            ...
            add(new int[]{IMediaPlayer.MEDIA_INFO_BAD_INTERLEAVING, 839}, "IT");
