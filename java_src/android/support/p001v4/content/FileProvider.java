    ...
    private static PathStrategy parsePathStrategy(Context context, String str) {
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                File buildPath = TAG_ROOT_PATH.equals(name) ? buildPath(DEVICE_ROOT, attributeValue2) : TAG_FILES_PATH.equals(name) ? buildPath(context.getFilesDir(), attributeValue2) : TAG_CACHE_PATH.equals(name) ? buildPath(context.getCacheDir(), attributeValue2) : TAG_EXTERNAL.equals(name) ? buildPath(Environment.getExternalStorageDirectory(), attributeValue2) : null;
                if (buildPath != null) {
