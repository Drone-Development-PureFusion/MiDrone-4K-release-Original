...
import android.support.p001v4.widget.SearchViewCompatHoneycomb;
...
public class SearchViewCompat {
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        @Override // android.support.p001v4.widget.SearchViewCompat.SearchViewCompatStubImpl, android.support.p001v4.widget.SearchViewCompat.SearchViewCompatImpl
        ...
        public Object newOnCloseListener(final OnCloseListenerCompat onCloseListenerCompat) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new SearchViewCompatHoneycomb.OnCloseListenerCompatBridge() { // from class: android.support.v4.widget.SearchViewCompat.SearchViewCompatHoneycombImpl.2
                @Override // android.support.p001v4.widget.SearchViewCompatHoneycomb.OnCloseListenerCompatBridge
                public boolean onClose() {
        ...
        public Object newOnQueryTextListener(final OnQueryTextListenerCompat onQueryTextListenerCompat) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new SearchViewCompatHoneycomb.OnQueryTextListenerCompatBridge() { // from class: android.support.v4.widget.SearchViewCompat.SearchViewCompatHoneycombImpl.1
                @Override // android.support.p001v4.widget.SearchViewCompatHoneycomb.OnQueryTextListenerCompatBridge
                public boolean onQueryTextChange(String str) {
    ...
    static class SearchViewCompatIcsImpl extends SearchViewCompatHoneycombImpl {
        ...
        @Override // android.support.p001v4.widget.SearchViewCompat.SearchViewCompatHoneycombImpl, android.support.p001v4.widget.SearchViewCompat.SearchViewCompatStubImpl, android.support.p001v4.widget.SearchViewCompat.SearchViewCompatImpl
        public View newSearchView(Context context) {
    ...
    static class SearchViewCompatStubImpl implements SearchViewCompatImpl {
        ...
        @Override // android.support.p001v4.widget.SearchViewCompat.SearchViewCompatImpl
        public CharSequence getQuery(View view) {
            return null;
        }
