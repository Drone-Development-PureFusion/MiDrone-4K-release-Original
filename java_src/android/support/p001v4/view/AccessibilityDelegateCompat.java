...
public class AccessibilityDelegateCompat {
    ...
    static class AccessibilityDelegateIcsImpl extends AccessibilityDelegateStubImpl {
        ...
        @Override // android.support.p001v4.view.AccessibilityDelegateCompat.AccessibilityDelegateStubImpl, android.support.p001v4.view.AccessibilityDelegateCompat.AccessibilityDelegateImpl
        ...
        public Object newAccessiblityDelegateBridge(final AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return AccessibilityDelegateCompatIcs.newAccessibilityDelegateBridge(new AccessibilityDelegateCompatIcs.AccessibilityDelegateBridge() { // from class: android.support.v4.view.AccessibilityDelegateCompat.AccessibilityDelegateIcsImpl.1
                @Override // android.support.p001v4.view.AccessibilityDelegateCompatIcs.AccessibilityDelegateBridge
    ...
    static class AccessibilityDelegateJellyBeanImpl extends AccessibilityDelegateIcsImpl {
        ...
        @Override // android.support.p001v4.view.AccessibilityDelegateCompat.AccessibilityDelegateIcsImpl, android.support.p001v4.view.AccessibilityDelegateCompat.AccessibilityDelegateStubImpl, android.support.p001v4.view.AccessibilityDelegateCompat.AccessibilityDelegateImpl
        public Object newAccessiblityDelegateBridge(final AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return AccessibilityDelegateCompatJellyBean.newAccessibilityDelegateBridge(new AccessibilityDelegateCompatJellyBean.AccessibilityDelegateBridgeJellyBean() { // from class: android.support.v4.view.AccessibilityDelegateCompat.AccessibilityDelegateJellyBeanImpl.1
                @Override // android.support.p001v4.view.AccessibilityDelegateCompatJellyBean.AccessibilityDelegateBridgeJellyBean
                public boolean dispatchPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
                    return accessibilityDelegateCompat.dispatchPopulateAccessibilityEvent(view, accessibilityEvent);
                }
    ...
    static class AccessibilityDelegateStubImpl implements AccessibilityDelegateImpl {
        ...
        @Override // android.support.p001v4.view.AccessibilityDelegateCompat.AccessibilityDelegateImpl
        public boolean dispatchPopulateAccessibilityEvent(Object obj, View view, AccessibilityEvent accessibilityEvent) {
            return false;
        }
