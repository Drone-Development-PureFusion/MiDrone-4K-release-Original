...
class RemoteInputCompatJellybean {
    ...
    static RemoteInputCompatBase.RemoteInput fromBundle(Bundle bundle, RemoteInputCompatBase.RemoteInput.Factory factory) {
        return factory.mo21688build(bundle.getString(KEY_RESULT_KEY), bundle.getCharSequence(KEY_LABEL), bundle.getCharSequenceArray(KEY_CHOICES), bundle.getBoolean(KEY_ALLOW_FREE_FORM_INPUT), bundle.getBundle(KEY_EXTRAS));
    }
    ...
    public static RemoteInputCompatBase.RemoteInput[] fromBundleArray(Bundle[] bundleArr, RemoteInputCompatBase.RemoteInput.Factory factory) {
        ...
        RemoteInputCompatBase.RemoteInput[] mo21689newArray = factory.mo21689newArray(bundleArr.length);
        for (int i = 0; i < bundleArr.length; i++) {
            mo21689newArray[i] = fromBundle(bundleArr[i], factory);
        }
