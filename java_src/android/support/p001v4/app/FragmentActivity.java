...
public class FragmentActivity extends Activity {
    ...
    /* renamed from: android.support.v4.app.FragmentActivity$FragmentTag */
    /* loaded from: classes.dex */
    ...
    public View onCreateView(String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        String attributeValue = attributeSet.getAttributeValue(null, AbstractC0301c.f553i);
        ...
        if (resourceId != -1) {
            fragment2 = this.mFragments.findFragmentById(resourceId);
        }
        if (fragment2 == 0 && string != null) {
            fragment2 = this.mFragments.findFragmentByTag(string);
        }
        if (fragment2 == 0 && i != -1) {
            fragment2 = this.mFragments.findFragmentById(i);
        }
        if (FragmentManagerImpl.DEBUG) {
            Log.v(TAG, "onCreateView: id=0x" + Integer.toHexString(resourceId) + " fname=" + attributeValue + " existing=" + ((Object) fragment2));
        }
        if (fragment2 == 0) {
            ...
            if (!fragment2.mRetaining) {
                fragment2.onInflate(this, attributeSet, fragment2.mSavedFragmentState);
            }
