...
public final class FragmentManagerImpl extends FragmentManager {
    ...
    @Override // android.support.p001v4.app.FragmentManager
                    ...
                    case 2:
                        if (i < 2) {
                            ...
                            if (fragment.mView != null && fragment.mContainer != null) {
                                Animation loadAnimation = (this.mCurState <= 0 || this.mDestroyed) ? null : loadAnimation(fragment, i2, false, i3);
                                if (loadAnimation != null) {
                                    fragment.mAnimatingAway = fragment.mView;
                                    fragment.mStateAfterAnimating = i;
                                    loadAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: android.support.v4.app.FragmentManagerImpl.5
                    ...
                    if (i > 1) {
                        ...
                        if (!fragment.mFromLayout) {
                            ...
                            if (fragment.mView != null) {
                                ...
                                fragment.mView = NoSaveStateFrameLayout.wrap(fragment.mView);
                                if (viewGroup != null) {
                                    Animation loadAnimation2 = loadAnimation(fragment, i2, true, i3);
