...
.method protected static a(Landroid/content/Context;Lorg/a/b/a;Lcom/xiaomi/xmpush/thrift/a;)Lcom/xiaomi/xmpush/thrift/ab;
    .locals 6
...
.method protected static a(Landroid/content/Context;Lorg/a/b/a;Lcom/xiaomi/xmpush/thrift/a;ZLjava/lang/String;Ljava/lang/String;)Lcom/xiaomi/xmpush/thrift/ab;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
    ...
    invoke-virtual {v3}, Lcom/xiaomi/mipush/sdk/a;->f()Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v1, v0}, Lcom/xiaomi/mipush/sdk/q;->b([B[B)[B
    :try_end_0
    ...
    iput-wide v4, v1, Lcom/xiaomi/xmpush/thrift/u;->a:J

    const-string v3, "fakeid"

    iput-object v3, v1, Lcom/xiaomi/xmpush/thrift/u;->b:Ljava/lang/String;

    invoke-virtual {v2, v1}, Lcom/xiaomi/xmpush/thrift/ab;->a(Lcom/xiaomi/xmpush/thrift/u;)Lcom/xiaomi/xmpush/thrift/ab;

    invoke-static {v0}, Ljava/nio/ByteBuffer;->wrap([B)Ljava/nio/ByteBuffer;

    move-result-object v0

    invoke-virtual {v2, v0}, Lcom/xiaomi/xmpush/thrift/ab;->a(Ljava/nio/ByteBuffer;)Lcom/xiaomi/xmpush/thrift/ab;

    invoke-virtual {v2, p2}, Lcom/xiaomi/xmpush/thrift/ab;->a(Lcom/xiaomi/xmpush/thrift/a;)Lcom/xiaomi/xmpush/thrift/ab;

    const/4 v0, 0x1

    invoke-virtual {v2, v0}, Lcom/xiaomi/xmpush/thrift/ab;->c(Z)Lcom/xiaomi/xmpush/thrift/ab;

    invoke-virtual {v2, p4}, Lcom/xiaomi/xmpush/thrift/ab;->b(Ljava/lang/String;)Lcom/xiaomi/xmpush/thrift/ab;

    invoke-virtual {v2, p3}, Lcom/xiaomi/xmpush/thrift/ab;->a(Z)Lcom/xiaomi/xmpush/thrift/ab;

    invoke-virtual {v2, p5}, Lcom/xiaomi/xmpush/thrift/ab;->a(Ljava/lang/String;)Lcom/xiaomi/xmpush/thrift/ab;
...
.method public static a(Landroid/content/Context;Lcom/xiaomi/xmpush/thrift/ab;)Lorg/a/b/a;
    .locals 3
    ...
    invoke-static {v1, v2}, Lcom/xiaomi/mipush/sdk/q;->a(Lcom/xiaomi/xmpush/thrift/a;Z)Lorg/a/b/a;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-static {v1, v0}, Lcom/xiaomi/xmpush/thrift/aq;->a(Lorg/a/b/a;[B)V
...
.method private static a(Lcom/xiaomi/xmpush/thrift/a;Z)Lorg/a/b/a;
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lcom/xiaomi/xmpush/thrift/x;->a(Z)V
